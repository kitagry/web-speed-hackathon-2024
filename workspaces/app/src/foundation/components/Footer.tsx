...
export const Footer: React.FC = () => {
  ...
  const { fetchContent: fetchTerm } = useContent('term');
  const { fetchContent: fetchContact } = useContent('contact');
  const { fetchContent: fetchQuestion } = useContent('question');
  const { fetchContent: fetchCompany } = useContent('company');
  const { fetchContent: fetchOverview } = useContent('overview');
  ...
  const handleRequestToTermDialogOpen = async () => {
    ...
    const termContent = await fetchTerm();
  ...
  const handleRequestToQuestionDialogOpen = async () => {
    ...
    const questionContent = await fetchQuestion();
  ...
  const handleRequestToCompanyDialogOpen = async () => {
    ...
    const companyContent = await fetchCompany();
  ...
  const handleRequestToOverviewDialogOpen = async () => {
    ...
    const overviewContent = await fetchOverview();
